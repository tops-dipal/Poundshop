<ul class="action-btns">
    @can('locations-edit')
    <li>
        <a class="btn-edit inline-edit" href="javascript:void(0);" id="{{$object->id}}" title="@lang('messages.modules.button_save')" onclick="edit_location({{$object->id}})"><span class="icon-moon icon-Edit"></span>
        </a>
    </li>
    @endcan
