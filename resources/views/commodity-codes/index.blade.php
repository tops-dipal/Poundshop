@extends('layouts.app')
@section('content')
@section('title',__('messages.modules.commodity_code_master'))
	<div class="content-card custom-scroll">
		<div class="content-card-header">
			<h3 class="page-title">@lang('messages.modules.commodity_code_master')</h3>	
			<div class="center-items">
	            <input type="text" class="txt-listing-search" id="search_data" name="" placeholder="@lang('messages.common.search_code')" />
	              <span class="refresh"></span>
	        </div>  
	        <div class="right-items"> 
	            @can('commoditycode-create')
	            <a class="btn btn-add btn-light-green btn-header" href="{{ route('commodity-codes.create') }}" title="@lang('messages.commodity_code_master.add_commodity_code')">
...
@endsection
@section('script')
<script type="text/javascript" src="{{asset('js/commodity-codes/index.js?v='.CSS_JS_VERSION)}}"></script>
@endsection