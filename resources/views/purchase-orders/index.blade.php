    ...
    <div class="card-flex-container d-flex">
        <div class="d-flex-xs-block">
            <div class="table-responsive">
                <table id="po_table" class="display table-striped" >
                    <thead>
                        <tr>
                            <th>
                                <div class="d-flex">
                            ...
                            <th class="text-right">
                                <span class="pr-3">@lang('messages.purchase_order.total_cost')</span>
                            </th>
                            <th class="w-100">@lang('messages.purchase_order.status')</th>
                            <th>Booking Date</th>
