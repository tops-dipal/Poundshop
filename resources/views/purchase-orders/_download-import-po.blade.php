                            ...
                            <table cellpadding="0" cellspacing="0" width="100%" style="margin-bottom: 5px;">
                                <tr>
                                    ...
                                    <td width="50%" align="right">
                                        <p style="font-size: 14px; margin: 0 0 5px 0;">@php isset($purchaseOrder->po_updated_at) && !empty($purchaseOrder->po_updated_at) ? 'Updated ' : ''; @endphp @lang('messages.po_pdf.pur_ord')
            ...
            <table cellpadding="5" cellspacing="0" width="100%" border="1" style="margin-top: 5px;border-collapse: collapse;">
                <thead style="font-size: 11px; font-weight: 600">
                    <tr>
                        ...
                        <td width="15%">@lang('messages.po_pdf.pro_title')</td>
                        ...
                        <td style="text-align: right;">@lang('messages.po_pdf.unit_price')</td>
                        <td style="text-align: right;">@lang('messages.po_pdf.total_val')</td>
                        <td>@lang('messages.po_pdf.vat_rate')</td>
                    </tr>
                </thead>
                @endif
                ...
                <tbody style="font-size: 10px;">
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <p style="margin: 0">{{$productsData[$k]->cube_per_box}}</p>
                            </p>
                            <p style="margin:0 0 3px 0;">
                                <strong style="font-weight: 600;">@lang('messages.po_pdf.cube_total')</strong>
                            <p style="margin: 0">{{$productsData[$k]->total_num_cubes}}</p>
                            </p>
                        </td>
