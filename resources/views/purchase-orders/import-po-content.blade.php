<div class="container-info shipping-container-cost po-item-data" style="@if(!empty($purchaseOrder->product) && @count($purchaseOrder->product) > 0 ) dispay:block; @else display:none; @endif">
    <a href="javascript:void(0)" id="toggle_container_info" class="shipping-toggle" title="@lang('messages.purchase_order.items.tables.container_info')">
        <span class="icon-moon icon-Import_Shipping_Cost"></span>
    </a>
