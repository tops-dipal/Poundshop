        ...
        <div class="card-flex-container">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-lg-8">
                        <div class="form-group row">
                            <label class="col-lg-3 col-form-label">@lang('messages.purchase_order.form.supplier')<span class="asterisk">*</span></label>
                            <div class="col-lg-9">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="form-group row">
                            <label class="col-lg-2 col-form-label">@lang('messages.bookings.form.status')</label>
                            <div class="col-lg-8">
                ...
                <div class="row" id="search-table-container" style="display: none;">
                    ...
                    <div class="row" id="search-table-container">
                        ...
                        <div class="col-lg-12">
                            <div class="form-group row">
                                <label class="col-lg-2 col-form-label">@lang('messages.bookings.form.search')</label>
                                <div class="col-lg-6">
                                ...
                                <div class="col-lg-4 pt-2">
                                    <label class="fancy-checkbox">
                                        ...
                                        <span><i></i> @lang('messages.bookings.form.show_cancelled')</span>
                                    </label>
                                    <a href="javascript:void(0)" id="resetBtn" class="btn-refresh ml-5">
                                        <span class="icon-moon icon-Refresh mr-2"></span>
                                        Reset
                                    </a>
                                </div>
                            </div>
                    ...
                    @else
                    <div  id="booking-slot-container" style="display:none;">
                        @include("bookings._add-booking-slot-form")
                    </div>
                    @endif
                                ...
                                <table id="po_listing_table" class="display">
                                    <thead>
                                        <tr>
                                            ...
                                            <th class="w-120">@lang('messages.bookings.po_table.po_no')</th>
                                            ...
                                            <th class="text-right">@lang('messages.bookings.po_table.po_val')</th>
