...
(function ($)
{
    ...
    c._listingView = function(){
        ...
        PoundShopApp.commonClass.table = PoundShopApp.commonClass._generateDataTable(PoundShopApp.commonClass.table,'pallets_table','api-pallets',field_coloumns,order_coloumns,undefined,undefined,'Search by Pallet Name');    
    };
    ...
    $(document).on('click', '.btn-delete', function (event) 
    {
        ...
        bootbox.confirm({ 
            ...
            callback: function (result) 
            {
                ...
                {
                    $.ajax({
                        url: BASE_URL + 'api-pallets-remove/'+id,
                        type: "post",
                        processData: false,
                        data:{id:id},
                        headers: {
            ...
            bootbox.confirm({ 
                ...
                callback: function (result) 
                {
                    if(result==true)
                    {
                        ...
                        $.ajax({
                            url: BASE_URL + 'api-pallets-remove-multiple',
                            type: "post",
                            processData: false,
                            ...
                            success: function (response) 
                            {
                                ...
                                //unchecked checkbox
                                //var chkbox_chkbox_select_allselect_all  = $('thead input[name="ids[]"]', $table).get(0);
...
{   
    ...
    $('#pallets_table tbody').on('click', 'input[type="checkbox"]', function(e)
    {
