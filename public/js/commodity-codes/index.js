...
{
    "user strict";
    var dataTableId = 'commoditycode_table';
    ...
    c._listingView = function(){
        ...
        PoundShopApp.commonClass.table = PoundShopApp.commonClass._generateDataTable(PoundShopApp.commonClass.table,'commoditycode_table','api-commodity-codes',field_coloumns,order_coloumns,undefined,undefined,'Search by Code');        };
    ...
    $(document).on('click', '.btn-delete', function (event) {
       ...
       bootbox.confirm({ 
            ...
            callback: function (result) 
            {
                ...
                {
                     $.ajax({
                        url: BASE_URL + 'api-commodity-codes-remove/'+id,
                        type: "post",
                        processData: false,
                        data:{id:id},
                        headers: {
                ...
                callback: function (result) 
                {
                    if(result==true)
                    {
                        var join_selected_values = allVals.join(","); 
                         $.ajax({
                            url: BASE_URL + 'api-commodity-codes-remove-multiple',
                            type: "post",
                            processData: false,
