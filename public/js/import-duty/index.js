...
{
    "user strict";
    var dataTableId = 'importduty_table';
    ...
    c._listingView = function(){
        ...
        PoundShopApp.commonClass.table = PoundShopApp.commonClass._generateDataTable(PoundShopApp.commonClass.table,'importduty_table','api-import-duty',field_coloumns,order_coloumns,undefined,undefined,'Search by Code');        };
        ...
        var id = $(this).attr("id"); 
         bootbox.confirm({           
            ...
            callback: function (result) 
            {
                ...
                {
                     $.ajax({
                        url: BASE_URL + 'api-import-duty-remove/'+id,
                        type: "post",
                        processData: false,
                        data:{id:id},
                        headers: {
                ...
                callback: function (result) 
                {
                    if(result==true)
                    {
                        var join_selected_values = allVals.join(","); 
                         $.ajax({
                            url: BASE_URL + 'api-import-duty-remove-multiple',
                            type: "post",
                            processData: false,
...
{   
    ...
    $('#importduty_table tbody').on('click', 'input[type="checkbox"]', function(e)
    {
