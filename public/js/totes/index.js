...
(function ($)
{
    ...
    c._listingView = function(){
        ...
        PoundShopApp.commonClass.table = PoundShopApp.commonClass._generateDataTable(PoundShopApp.commonClass.table,'totes_table','api-totes',field_coloumns,order_coloumns,undefined,undefined,'Search by Tote Name');        };
    ...
    $(document).on('click', '.btn-delete', function (event) {
        ...
        bootbox.confirm({ 
            ...
            callback: function (result) 
            {
                ...
                {
                 $.ajax({
                        url: BASE_URL + 'api-totes-remove/'+id,
                        type: "post",
                        processData: false,
                        data:{id:id},
                        headers: {
                ...
                callback: function (result) 
                {
                    if(result==true)
                    {
                        var join_selected_values = allVals.join(","); 
                         $.ajax({
                            url: BASE_URL + 'api-totes-remove-multiple',
                            type: "post",
                            processData: false,
