...
(function ($)
{
    ...
    c._listingView = function(){
        ...
        PoundShopApp.commonClass.table = PoundShopApp.commonClass._generateDataTable(PoundShopApp.commonClass.table,'warehouse_table','api-warehouse',field_coloumns,order_coloumns,undefined,undefined,'Search by Warehouse Name');    
    };
    ...
    $(document).on('click', '.btn-delete', function (event) 
    {
        ...
        bootbox.confirm({ 
            ...
            callback: function (result) 
            {
                ...
                {
                    $.ajax({
                        url: BASE_URL + 'api-warehouse-remove/'+id,
                        type: "post",
                        processData: false,
                        data:{id:id},
                        headers: 
            ...
            bootbox.confirm({ 
                ...
                callback: function (result) 
                {
                    if(result==true)
                    {
                        ...
                        $.ajax({
                            url: BASE_URL + 'api-warehouse-remove-multiple',
                            type: "post",
                            processData: false,
...
{   
    ...
    $('#warehouse_table tbody').on('click', 'input[type="checkbox"]', function(e)
    {
