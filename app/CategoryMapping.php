...
class CategoryMapping extends Model
{
    ...
    public static function getAllMapping($perPage = '',$params = array())
    {
    	...
    	$cat->Join('range_master', 'range_master.id', 'category_mappings.range_id');
    	$cat->Join('magento_categories', 'magento_categories.id', 'category_mappings.magento_category_id');
