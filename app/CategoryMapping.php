...
class CategoryMapping extends Model
{
    ...
    {
    	$cat=self::select('range_master.category_name','range_master.path','magento_categories.structure','category_mappings.*');
    	...
    	$cat->orderBy("category_mappings.".$params['order_column'],$params['order_dir']);
