...
class BarcodeImageController extends Controller
{
	...
	{		
		...
		$text = (isset($request->text)?$request->text:"0");
		$size = (isset($request->size)?$request->size:"20");
		$orientation = (isset($request->orientation)?$request->orientation:"horizontal");
		$code_type = (isset($request->codetype)?$request->codetype:"code128");
		$code_string = "";
