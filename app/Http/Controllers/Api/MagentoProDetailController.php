...
class MagentoProDetailController extends Controller
{
    ...
    public function index(Request $request)
    {
		try
		{
            ...
            if($this->magento->USER_NAME!='' && $this->magento->PASSWORD!='' && $this->magento->ENDPOINT!='') 
			{
                ...
                {
                    $operation_perform=$this->invoke_product_detail();
                }
    ...
    public function invoke_product_detail() 
    {
        $operation_perform=0;
    ...
    public function invoke_product_detail_update() 
    {
        $operation_perform=0;
        $this->magento_pro = new MagentoProduct;
    ...
    public function insertProductAttributes($attributeDetail) 
    {
    ...
    public function insertProductAttributeMapping($VarProdAttributes) 
    {
    ...
    public function insertProductImages($imagesData,$magentoProductId,$productId,$main_image=NULL) 
    {
    ...
    public function set_vendor($vendor_name)
    {
