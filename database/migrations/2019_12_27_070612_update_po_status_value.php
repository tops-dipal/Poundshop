...
class UpdatePoStatusValue extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
      Schema::table('purchase_order_master', function (Blueprint $table) {
             $table->smallInteger('po_status')->comment('1-Draft(default),2-live po(sent po),3-negotiating with supplier,4-supplier confirmed,5-book in,6-Part Delivered,7-Arrived,8-Receiving,9-Completed,10-Cancelled ')->change();
        });
    }
